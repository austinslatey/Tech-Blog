...
const commentdata = [
  ...
  {
    comment_text: "So what are your thoughts about Brexit? Do you think it was bad thing or a good thing?",
    user_id: 1,
    post_id: 15,
  },
  {
    comment_text: "From my point of view you are not right Sam, you made a mistake and you have to fix them yourself. This how I see it…",
    user_id: 4,
    post_id: 16,
  },
  {
  ...
  {
    comment_text: "I just bought a couple of stickers for my bag and I am really happy with my purchase, do you guys want to see a picture of it?",
    user_id: 4,
    post_id: 10,
  },
  {
    comment_text: "Hello darkness my old friend, awesome music, I really love Disturbed edition of it.",
    user_id: 7,
    post_id: 5,
  },
  {
    comment_text: "Sorry for dumb questions guys, I am just really new to this subject and a lot of different stuff is still not clear for me, anyway thank you for answering, I really appreciate it.",
    user_id: 10,
    post_id: 1,
  },
  {
    comment_text: "Unity player? What is it? Do I have to install it in order to play your game? Where can I find it?",
    user_id: 3,
    post_id: 19,
  },
  {
    comment_text: "Jane is right, she was 100% right about this issue, follow her guide step by step and you will resolve this bug.",
    user_id: 5,
    post_id: 3,
  },
  {
  ...
  {
    comment_text: "Using your article and walkthrough, I am impressed by the results which I achieved so far.",
    user_id: 10,
    post_id: 8,
  },
  {
    comment_text: "Join our community guys, together we can make some difference, together we can achieve more.",
    user_id: 10,
    post_id: 11,
  },
  {
    comment_text: "I do not really need problems right now, I will skip this project for now, need to finish previous one first.",
    user_id: 8,
    post_id: 5,
  },
  {
    comment_text: "Reading books these days is like wearing weird outfit, do you want to know why? Because it attracts too much attention.",
    user_id: 8,
    post_id: 19,
  },
  {
  ...
  {
    comment_text: "So exciting news today is that there are brand new heroes in Dota, the bad news is that we still lack good players :D",
    user_id: 4,
    post_id: 6,
  },
  {
    comment_text: "Trusting politician is the worst thing you can do, but people are funny, they repeat same mistake.",
    user_id: 9,
    post_id: 6,
  },
  {
  ...
  {
    comment_text: "Which movie is your favorite one? I think mine is The Book Thief. I really admired death monologues in it.",
    user_id: 4,
    post_id: 19,
  },
  {
    comment_text:
      "Love you guys, keep up good work. Write more often please.",
    user_id: 10,
    post_id: 1,
  },
  {
  ...
  {
    comment_text: "It will take me forever to write another article about this subject, can you please visit my YouTube channel and find a video titled: How to use PHPMyAdmin? Thanks.",
    user_id: 10,
    post_id: 1,
  },
  {
